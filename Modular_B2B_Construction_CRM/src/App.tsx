    ...
    <div className="min-h-screen bg-gradient-to-br from-[#111827] via-[#1F2937] to-[#374151] flex items-center justify-center p-8">
      <div className="max-w-6xl w-full">
        ...
        <div className="text-center mb-16">
          <div className="w-24 h-24 bg-gradient-to-br from-[#F59E0B] to-[#EA580C] rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-2xl">
            <span className="text-white font-bold text-4xl">GA</span>
          </div>
