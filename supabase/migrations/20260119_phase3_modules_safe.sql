-- Phase 3 Safe Migration (handles existing objects)
-- Run this version if you get "already exists" errors

-- ============================================
-- 1. Public Quote Links (Shareable URLs)
-- ============================================
...
-- Create indexes
DROP INDEX IF EXISTS idx_quote_status_history_quotation;
CREATE INDEX idx_quote_status_history_quotation ON quote_status_history(quotation_id);

DROP INDEX IF EXISTS idx_quote_status_history_status;
CREATE INDEX idx_quote_status_history_status ON quote_status_history(to_status);

DROP INDEX IF EXISTS idx_quote_status_history_changed_at;
...
-- ============================================
-- 4. Customer Responses (Accept/Reject/Changes)
-- ============================================
...
-- Migration Complete
-- ============================================
-- All Phase 3 tables, indexes, functions, and triggers created successfully
