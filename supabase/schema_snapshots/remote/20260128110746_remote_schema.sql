...
drop trigger if exists "email_tracking_updated_at" on "public"."quote_email_tracking";
...
drop policy "Users can create quote lines for own quotes" on "public"."quote_lines";

drop policy "Users can delete quote lines for own quotes" on "public"."quote_lines";

drop policy "Users can update quote lines for own quotes" on "public"."quote_lines";

drop policy "Users can view quote lines for own quotes" on "public"."quote_lines";
...
revoke delete on table "public"."quote_lines" from "anon";

revoke insert on table "public"."quote_lines" from "anon";

revoke references on table "public"."quote_lines" from "anon";

revoke select on table "public"."quote_lines" from "anon";

revoke trigger on table "public"."quote_lines" from "anon";

revoke truncate on table "public"."quote_lines" from "anon";

revoke update on table "public"."quote_lines" from "anon";

revoke delete on table "public"."quote_lines" from "authenticated";

revoke insert on table "public"."quote_lines" from "authenticated";

revoke references on table "public"."quote_lines" from "authenticated";

revoke select on table "public"."quote_lines" from "authenticated";

revoke trigger on table "public"."quote_lines" from "authenticated";

revoke truncate on table "public"."quote_lines" from "authenticated";

revoke update on table "public"."quote_lines" from "authenticated";

revoke delete on table "public"."quote_lines" from "service_role";

revoke insert on table "public"."quote_lines" from "service_role";

revoke references on table "public"."quote_lines" from "service_role";

revoke select on table "public"."quote_lines" from "service_role";

revoke trigger on table "public"."quote_lines" from "service_role";

revoke truncate on table "public"."quote_lines" from "service_role";

revoke update on table "public"."quote_lines" from "service_role";
...
alter table "public"."quote_lines" drop constraint "quote_lines_quote_id_fkey";

alter table "public"."quotes" drop constraint "quotes_job_id_fkey";

alter table "public"."quotes" drop constraint "quotes_price_book_id_fkey";
...
drop function if exists "public"."update_email_tracking_updated_at"();
...
alter table "public"."quote_lines" drop constraint "quote_lines_pkey";
...
drop index if exists "public"."idx_quote_lines_quote_id";

drop index if exists "public"."idx_quotes_created_at";

drop index if exists "public"."idx_quotes_job_id";

drop index if exists "public"."idx_quotes_price_book_id";
...
drop index if exists "public"."quote_lines_pkey";
...
alter table "public"."price_books" add column "currency" text not null default 'INR'::text;

alter table "public"."price_books" add column "is_active" boolean not null default false;

alter table "public"."price_books" add column "name" text not null;

alter table "public"."price_books" add column "updated_at" timestamp with time zone not null default now();
...
alter table "public"."quote_email_tracking" add column "clicked_at" timestamp with time zone;

alter table "public"."quote_email_tracking" add column "error_message" text;

alter table "public"."quote_email_tracking" add column "opened_at" timestamp with time zone;

alter table "public"."quote_email_tracking" add column "provider_message_id" text;
